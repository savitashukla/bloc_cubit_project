...
import 'package:cubit_project/view/game_zop/game_zop_webview.dart';
...
class GameZopList extends StatefulWidget {
  String gameId;

  GameZopList(this.gameId, {Key? key}) : super(key: key);

  @override
  State<GameZopList> createState() => _GameZopListState();
}

class _GameZopListState extends State<GameZopList> {
  ...
  void initState() {
    ...
    gamezopEventListCubit!.getGameEventList(widget.gameId);
              ...
              child: Column(
                children: [
                            ...
                            child: InkWell(
                              onTap: () {
                                ...
                                gamezopEventListCubit!
                                    .getGameEventList(widget.gameId);
                              },
                              child: Column(
                                children: [
                                  const Text(
                  ...
                  Visibility(
                    ...
                    child: state.gameEventListR != null
                        ? state.gameEventListR!.data != null
                            ? ListView.builder(
                                itemCount: state.gameEventListR?.data?.length,
                                shrinkWrap: true,
                      ...
                      children: [
                        ...
                        /* url != null && url.isNotEmpty
                         ...
                         Image(
                          ...
                          width: 35,
                          fit: BoxFit.cover,
                          image: AssetImage(ImageRes().poolLogo),
                        ),
                        Container(
                          width: 5,
                        ),
  ...
  Widget triviaListotherNotUse(BuildContext context, int index) {
    return Container(
        child: gamezopEventListCubit!.state.gameEventListR!.data![index].entry!
                    .feeBonusPercentage! >=
                100
            ? GestureDetector(
                onTap: () async {
                  getPreJoinEventGameZob(
                      index,
                      gamezopEventListCubit!
                          .state.gameEventListR!.data![index].id,
                      context,
                      gamezopEventListCubit!.state.gameEventListR!.data![index]
                          .entry!.fee!.value);
                                                      ...
                                                      ? Text(
                                                          gamezopEventListCubit!
                                                              ...
                                                              ? gamezopEventListCubit!
                                                                  ...
                                                                  .value
                                                                  .toString()
                                                              : "${AppString().txtCurrencySymbol} ${gamezopEventListCubit!.state.gameEventListR!.data![index].entry!.fee!.value! ~/ 100}",
                                                          textAlign:
                                                              TextAlign.center,
                                                          style: TextStyle(
                                                              fontSize: 14,
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      child:*/
                                            Center(
                                              child: Text(
                                                "\u{20B9} ${gamezopEventListCubit!.state.gameEventListR!.data![index].winner!.prizeAmount!.value! ~/ 100}",
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                    fontSize: 19,
                                                    fontWeight: FontWeight.w700,
                                  ...
                                  children: [
                                    ...
                                    child: _userController
                                        ...
                                        controller.unityEventList.value
                                            ...
                                            .getBonuse()
                                        ? Text(
                                      "${gamezopEventListCubit!.state.gameEventListR!.data![index].entry!.getBonuse()}",
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                        fontSize: 14,
                                        fontFamily: "UltimaPro",
                            ...
                            Row(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    gamezopEventListCubit!.state.gameEventListR!
                                        .data![index].name!
                                        .toUpperCase(),
                                    textAlign: TextAlign.start,
                                    style: TextStyle(
...
// only show bonus entry not check wallet condition
                                  Padding(
                                    padding: const EdgeInsets.only(
                                        right: 8.0, left: 5),
                                    child: Text(
                                      "${((gamezopEventListCubit!.state.gameEventListR!.data![index].entry!.fee!.value! / 100 * gamezopEventListCubit!.state.gameEventListR!.data![index].entry!.feeBonusPercentage!) / 100)}",
                                      textAlign: TextAlign.center,
                                      style: const TextStyle(
                                        fontSize: 14,
                                        fontFamily: "UltimaPro",
                              ...
                              child: _userController
                                  ...
                                  controller.unityEventList.value
                                      ...
                                      .getBonuse()
                                  ? Text(
                                "${gamezopEventListCubit!.state.gameEventListR!.data![index].entry.g}",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  fontSize: 14,
                                  fontFamily: "UltimaPro",
                    ...
                    Row(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            "${gamezopEventListCubit!.state.gameEventListR!.data![index].winner!.prizeAmount!.value! ~/ 100}",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 15,
                              height: 0,
      ...
      if (preJoinResponseModel != null) {
        ...
        if (deficitAmount!.value! > 0) {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (BuildContext context) => GameZopWebView(
                preJoinResponseModel.webViewUrl,
                "${widget.gameId}",
                event_id,
                "${gamezopEventListCubit!.state.gameEventListR!.data![index].entry!.fee!.value! > 0 ? gamezopEventListCubit!.state.gameEventListR!.data![index].entry!.fee!.value! ~/ 100 : "0"}",
              ),
            ),
          );

          //showPreJoinBox(index,navigatorKey.currentState!.context, "$event_id", preJoinResponseModel);
                      ...
                      Expanded(
                        ...
                        child: Wrap(
                          children: [
                            ...
                            Text(
                                "${gamezopEventListCubit!.state.gameEventListR!.data![index].entry!.fee!.value! > 0 ? gamezopEventListCubit!.state.gameEventListR!.data![index].entry!.fee!.value! ~/ 100 : "Free"}")
                          ],
                        ),
                      )
                    ],
