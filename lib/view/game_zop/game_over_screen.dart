...
class GameOverScreenGameZop extends StatefulWidget {
  String? event_id;
  String? gameid;
  String? playAmount;

  GameOverScreenGameZop(
    this.gameid,
    this.event_id,
    this.playAmount,
  );
  ...
  @override
  State<GameOverScreenGameZop> createState() => GameOverScreenGameZopState();
}

class GameOverScreenGameZopState extends State<GameOverScreenGameZop>
...
/*  Match_Making_Screen_Controller match_Making_Screen_Controlleer =
                                                                ...
                                                                child:
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    fit: BoxFit
                                                                        .fill,
                                                                    imageUrl:
                                                                        ("${state.profileDataC!.photo != null && state.profileDataC!.photo!.url != null}"),
                                                                  ),
                                                                ),
                                                              )),
                                                  )
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                            builder: (BuildContext context) => GameZopList(
                                              "${widget.gameid}",
                                            ),
                                          ),
                                        );
          ...
          Future.delayed(const Duration(seconds: 6), () {
            if (cancel) {
              ...
              Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                      builder: (context) => GameZopWebView(
                          preJoinResponseModel.webViewUrl,
                          widget.gameid,
                          widget.event_id,widget.playAmount
                          )));
              //  cancel = true;
              //RE PLAY event
              /*    try {
                Map<String, dynamic> map = new Map<String, dynamic>();
                map["game_id"] = widget.gameid;
  ...
  Future<void> getPreJoinEventGameZobClick(String? event_id) async {
    if (token == null) {
      prefs = await SharedPreferences.getInstance();
      token = prefs!.getString("token")!;
      user_id = prefs!.getString("userId")!;
