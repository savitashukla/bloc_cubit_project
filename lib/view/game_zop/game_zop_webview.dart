...
import 'package:cubit_project/view/game_zop/game_over_screen.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:webview_flutter/webview_flutter.dart';

import '../../utils/logger_utils.dart';

class GameZopWebView extends StatefulWidget {
  ...
  GameZopWebView(
      this.url, this.gameid, this.event_id, this.playAmount);

  @override
  State<GameZopWebView> createState() => _GameZopWebViewState();
}

class _GameZopWebViewState extends State<GameZopWebView> {
          ...
          onMessageReceived: (JavaScriptMessage message) {
            ...
            if (resData["event"] == "match_over" ||
              ...
              Navigator.push(
                ...
                MaterialPageRoute(builder: (context) => GameOverScreenGameZop(widget.gameid,widget.event_id,widget.playAmount)),
              );
