class TamashaEventListD {
  ...
  TamashaEventListD.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <TamashaEventList>[];
      json['data'].forEach((v) {
        data!.add(new TamashaEventList.fromJson(v));
      });
    }
...
class TamashaEventList {
 ...
 int? onlinePlayers;
  ...
  TamashaEventList({this.contestId,
    this.startDate,
    this.contestName,
    this.endDate,
    this.gameId,
  ...
  TamashaEventList.fromJson(Map<String, dynamic> json) {
