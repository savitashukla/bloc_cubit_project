class GameEventListHistory {
  List<HistoryData>? data;
  Pagination? pagination;

  GameEventListHistory({this.data, this.pagination});

  GameEventListHistory.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <HistoryData>[];
      json['data'].forEach((v) {
